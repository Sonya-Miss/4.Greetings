...
const letterPuzzlesData = [
    { phrase: "Hello", image: "./Pictures/Привіт.jpg" },
    { phrase: "Hi", image: "./Pictures/Привіт.jpg" },
    { phrase: "Good morning", image: "./Pictures/Добрий ранок.jpg" },
    { phrase: "Good afternoon", image: "./Pictures/Добрий день.jpg" },
    { phrase: "Good evening", image: "./Pictures/Добрий вечір.jpg" },
    { phrase: "Good night", image: "./Pictures/Добраніч.jpg" }
];
...
const audioPuzzlesData = [
    ...
    { word: "Good night", audio: "./Audio/Good night.mp3" },
];
...
const draggableWordsContainer = document.getElementById('draggable-words-container'); // Для гри 1
// Для гри 3
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const game1Title = document.getElementById('game1-title'); // Припустимо, у вас є ID для заголовків
    const game2Title = document.getElementById('game2-title');
    const draggableWordsContainerMain = document.getElementById('draggable-words-container'); // Банк слів Гри 1

    if (game2Title && draggableWordsContainerMain && game1Title) { 
        new IntersectionObserver(([entry]) => {
            if (entry.isIntersecting) { // Якщо заголовок Гри 2 видно
                draggableWordsContainerMain.classList.add('hidden'); // Ховаємо банк слів Гри 1
                game1Title.classList.add('hidden'); // Ховаємо заголовок Гри 1
            } else { // Якщо заголовок Гри 2 не видно
                draggableWordsContainerMain.classList.remove('hidden'); // Показуємо банк слів Гри 1
                game1Title.classList.remove('hidden'); // Показуємо заголовок Гри 1
            }
        }, { threshold: 0.1 }).observe(game2Title); // Спостерігаємо за заголовком Гри 2
    }
});
